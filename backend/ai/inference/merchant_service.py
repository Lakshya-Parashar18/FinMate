"""
Merchant_service.py
Merchant string cleaning, corporate suffix normalization, and unknown merchant handling.
"""
...
class MerchantService:
    """Production merchant string normalization and cleaning engine."""
    ...
    @classmethod
    def normalize_merchant(cls, merchant_raw: str) -> Tuple[str, bool]:
        """
        Returns tuple of (normalized_canonical_name, is_unknown).
        """
